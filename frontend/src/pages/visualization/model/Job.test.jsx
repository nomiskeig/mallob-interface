...
test('returns subtree with parent', () => {
    ...
    expect(subtree.includes(child)).toBeTruthy();
    expect(subtree.includes(parent)).toBeTruthy();
...
test('returns bigger subtree', () => {
    ...
    expect(subtree1.length).toBe(8)
    vertices.forEach(e => {
        expect(subtree1.includes(e)).toBeTruthy();
    })
...
test('returns correct subtree when subtree has is not connected', () => {
    ...
    expect(subtree.includes(vertex1)).toBeTruthy();
    expect(subtree.includes(vertex2)).toBeTruthy();
    expect(subtree.includes(vertex3)).toBeTruthy();
